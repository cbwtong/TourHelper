...
public class DBHelper {
	...
	public void upDataLocation(MapLocation location){
	    	ContentValues values = new ContentValues();
	        values.put(IDBValues.COL_LAT, location.getLatitude());
	        values.put(IDBValues.COL_LONG, location.getLongitude());
	        values.put(IDBValues.COL_TYPE, location.getMarkType());
	        values.put(IDBValues.COL_NAME, location.getName());
	        values.put(IDBValues.COL_DESCRIPTION, location.getDescription());
	        values.put(IDBValues.COL_RES, location.getResURL());
	        
	        String [] whereString = {location.getName()};
	        
	         sqlDB.update(IDBValues.TABLE_LOCATIONS, values, "loc_name=?", whereString );
	...
	public ArrayList<MapLocation> getSavedLocations(){
        ...
        while (cursor.moveToNext()) {
            ...
            location.setMarkType(Integer.parseInt(cursor.getString(cursor
            		.getColumnIndex(IDBValues.COL_TYPE))));
            ...
            location.setResURL(cursor.getString(cursor
                    .getColumnIndex(IDBValues.COL_RES))); 
